...
class Smart_mall extends CI_Controller 
{
	...
	function update_user()	// Update user information after login
	{
		...
		{			
			...
			//$this->form_validation->set_rules('Shop_Logo', 'Shop Logo', 'xss_clean');
			...
			else
			{
				...
				{
					$message = 'Shop Logo could not be uploaded!';
					$this->session->set_flashdata('message', $message);
				}
				else
				{
					$upload_data = $this->upload->data();
					$_POST['Shop_Logo'] = './uploads/shops/'.$upload_data['file_name'];
				}
				
				//var_dump($_POST['Shop_Logo']);
