...
?>
<title>Smart Mall - Add Restaurant Menu</title>
...
<div class="posts span-16 last" id="main">
	...
	<div class="breadcrumb">
		<div class="breadcrumb-toolbar">
			...
			<a href="<?php echo $controller_url; ?>/restaurant_menu_add" title="Add Restaurant Menu">Add Restaurant Menu</a>
        </div>
                ...
                <div>
					...
					<br/>-->
						...
						<?php echo validation_errors(); 
							  ...
							  echo form_open_multipart("$controller_url"."/restaurant_menu_add", $attributes);
						?>
							<p class="blocktext">
							Item Name:
							<?php
