...
<body class="home blog">
	...
	<div class="container">
        ...
        <div id="header" class="span-8">			
            ...
            <a id="logo" href="<?php echo $controller_url; ?>/main_page" title="Device Tracker" style="background-image:url(<?php echo $content_url; ?>images/logo.png)">mobile Pro</a>
            </div>
            ...
            <div class="menu-primary">
				<ul id="menu-main" class="v-list">
					...
					<!--<li id="menu-item-236" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-236">
						<a href="<?php echo $controller_url; ?>/register_devices">Add/Change Device</a>
					</li>
					<li id="menu-item-12" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-12">
						<a href="<?php echo $controller_url; ?>/track_devices">Track my Device</a>
					</li>-->
