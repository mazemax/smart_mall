...
?>
<title>Smart Mall - Update Product</title>
...
<div class="posts span-16 last" id="main">
	...
	<div class="breadcrumb">
		<div class="breadcrumb-toolbar">
			...
			<a href="<?php echo $controller_url; ?>/product_entry" title="Register Devices">Add Product</a>
        </div>
                ...
                <div>
					...
					<br/>-->
						...
						<?php echo validation_errors(); 
							  ...
							  echo form_open_multipart("$controller_url"."/product_update/".$data['Product_Code'], $attributes);
						?>
							<p class="blocktext">
							Product Code:
							<?php
							...
							$data4 = array(
								  'name'        => 'p_quantity',
								  'id'          => 'p_quantity',
								  'value'       => $data['Product_QuantityInStore'],
								  'maxlength'   => '50',
								  'size'        => '25',
								  //'style'       => 'width:50%',
								);
							...
							Product Poster:
								...
								if ($data['Product_Poster'] != NULL)	// If image is in DB then show it
								{
									$path_parts = pathinfo($data['Product_Poster']);
