...
<div class="posts span-16 last" id="main">
	...
	<div class="breadcrumb">
		<div class="breadcrumb-toolbar">
			...
			<a href="<?php echo $controller_url; ?>/movie_add" title="Add Movie">Add Movie</a>
        </div>
                ...
                <div>
					...
					<br/>-->
						...
						<?php echo validation_errors(); 
							  ...
							  echo form_open_multipart("$controller_url"."/movie_add", $attributes);
						?>
							<p class="blocktext">
							Movie Name:
							<?php
							...
							<p class="blocktext">
							<?php echo form_submit('p_reg_save', 'Add'); ?>
