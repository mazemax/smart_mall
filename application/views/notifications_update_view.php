...
?>
<title>Smart Mall - Update Notification</title>
...
<link rel="stylesheet" href="<?php echo $content_url; ?>style3.css"  type="text/css" />
...
<link rel="stylesheet" href="http://code.jquery.com/ui/1.7.3/themes/smoothness/jquery-ui.css" />
<script src="http://code.jquery.com/ui/1.7.3/jquery-ui.js"></script>

<link rel="stylesheet" type="text/css" href="<?php echo $content_url; ?>js/jquery/plugins/jquery-ui-timepicker-0.3.2/jquery.ui.timepicker.css"/>
<script type="text/javascript" src="<?php echo $content_url; ?>js/jquery/plugins/jquery-ui-timepicker-0.3.2/jquery.ui.timepicker.js"></script>
...
<script>
  $(function() 
  {
    $("#Notification_StartDate").datepicker();
	$("#Notification_EndDate").datepicker();
  });
</script>
            ...
            <div style="background-image:url(<?php echo $content_url; ?>images/headers/1_grey.png)" class="banner">                
                <div class="social">
                    <ul class="h-list">
						...
						<li><a href="#" target="_blank">								<img src="<?php echo $content_url; ?>images/facebookIcon.png"  alt="facebook"  /></a></li>
                    </ul>
                </div>
            ...
            <div class="menu-primary">
				<ul id="menu-main" class="v-list">
					...
					<?php } 
						  if($role==3) {	?>
					<li id="menu-item-236" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-236">
						<a href="<?php echo $controller_url; ?>/restaurant_menu_add">Add Restaurant Menu</a>
					</li>
					<?php } ?>
					<li id="menu-item-236" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-236">
                ...
                <div>
					...
					<br/>-->
						...
						<?php echo validation_errors(); 
							  ...
							  echo form_open_multipart("$controller_url"."/notifications_update/".$data['Notification_ID'], $attributes);
						?>
							<p class="blocktext">
							Description:
							<?php
							$data1 = array(
								  ...
								  //'cols'   	=> '2',
								  //'rows'      => '2',
								  'style'       => 'width:218px !important; height: 160px !important; background-color:#DFDFDF !important; border:0px !important;',
								);
							...
							if ($data['Notification_Details'] != NULL)	// If image is in DB then show it
							{
								$path_parts = pathinfo($data['Notification_Details']);
								$pic_path = $content_url.ltrim($path_parts['dirname'], "./")."/".$path_parts['basename'];
								echo "<img src='".$pic_path."' height='220' width='220'>";
							}
							?>
							...
							$data3 = array(
								  ...
								  'value'       => $data['Notification_StartDate'],
								  'maxlength'   => '50',
								  'size'        => '25',
								  //'style'       => 'width:50%',
								);
							...
							<?php
							$data4 = array(
								  'name'        => 'Notification_EndDate',
								  'id'          => 'Notification_EndDate',
								  'value'       => $data['Notification_EndDate'],
								  'maxlength'   => '50',
								  'size'        => '25',
								  //'style'       => 'width:50%',
								);
							...
							<p class="blocktext">
							<?php echo form_submit('p_reg_save', 'Update'); ?>
							<?php echo form_submit('p_reg_cancel', 'Cancel'); ?>
							</p>
						<?php echo form_close(); ?>
