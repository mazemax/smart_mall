...
?>
<title>Smart Mall - Add Notification</title>
...
<div class="posts span-16 last" id="main">
	...
	<div class="breadcrumb">
		<div class="breadcrumb-toolbar">
			...
			<a href="<?php echo $controller_url; ?>/notifications_add" title="Add Notification">Add Notification</a>
        </div>
                ...
                <div>
					...
					<br/>-->
						...
						<?php echo validation_errors(); 
							  ...
							  echo form_open_multipart("$controller_url"."/notifications_add", $attributes);
						?>
							<p class="blocktext">
							Description:
							<?php
