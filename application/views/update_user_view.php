...
?>
<title>Smart Mall - Account Settings</title>
...
<div class="posts span-16 last" id="main">
	...
	<div class="breadcrumb">
		<div class="breadcrumb-toolbar">
			...
			<a href="<?php echo $controller_url; ?>/update_user" title="Account Settings">Account Settings</a>
        </div>
            ...
            <div class="post-info">
                ...
                <div>
					...
					<br/>-->
						...
						<?php $attributes = array('id'=>'my-form');
							  echo form_open_multipart("$controller_url"."/update_user", $attributes); 
						
							  $info = array();
							  foreach($user_data[0] as $user)
							  {
									$info[] = $user;				  	
							  }	// foreach			  
						?>
							...
							$other_data = 'id="User_Type" style="width:225px;"';
							echo form_dropdown('User_Type', $options, $user_data[0]['User_Type'], $other_data);
							?>
							...
							{	?>
								...
								<?php
								$Shop_No = isset($shop[0]['Shop_No']) ? $shop[0]['Shop_No'] : '';
								$data4 = array(
									  'name'        => 'Shop_No',								  
									  'value'       => $Shop_No,
									  //'style'       => 'width:50%',
								...
								<?php
								$Shop_Name = isset($shop[0]['Shop_Name']) ? $shop[0]['Shop_Name'] : '';
								$data5 = array(
									  'name'        => 'Shop_Name',								  
									  'value'       => $Shop_Name,
									  //'style'       => 'width:50%',
							...
							<br/><br/>
							<?php echo form_submit('new_user_submit', 'Update my Account'); ?>
							</p>
						<?php echo form_close(); ?>
