...
function do_delete(id)
{
	...
	if (r==true)
	  window.location = url+"/product_delete/"+id;
	else
	  return false;
}
</script>
					...
					<p class="blocktext">
						...
						if(!empty($products))
						{
							foreach($products as $p)
							{
								...
								echo "<td>".$p['Product_Brand']."</td>";
								echo "<td>".$p['Product_QuantityInStore']."</td>";
								echo "<td>".$p['Product_UnitPrice']."</td>";
								echo "<td><a href='".$controller_url."/product_update/".$p['Product_Code']."'><img src='".$content_url."images/Edit.png'></a></td>";
								echo "<td><a href='javascript:void(0);' onClick='do_delete(".$p['Product_Code'].");'><img src='".$content_url."images/Delete.png'></a></td>";
								echo "</tr>";
							}
						}
						?>
