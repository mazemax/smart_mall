...
?>
<title>Smart Mall - Add Movie</title>
...
<script>
  $(function() 
  {
    $("#Movie_ShowDate").datepicker();
	$("#Movie_ShowTime").timepicker();
  });
</script>
            ...
            <div class="menu-primary">
				<ul id="menu-main" class="v-list">
					...
					<li id="menu-item-236" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-236">
						<a href="<?php echo $controller_url; ?>/product_entry">Add Product</a>
					</li>
					<?php } 
						  if($role==5) { ?>
					<li id="menu-item-236" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-236">
                ...
                <div>
					...
					<br/>-->
						...
						<?php echo validation_errors(); 
							  ...
							  echo form_open_multipart("$controller_url"."/movie_update/".$data['Movie_ID'], $attributes);
						?>
							<p class="blocktext">
							Movie Name:
							<?php
							...
							<?php
							$data2 = array(
								  'name'        => 'Movie_TicketPrice',
								  'id'          => 'Movie_TicketPrice',
								  'value'       => $data['Movie_TicketPrice'],
								  'maxlength'   => '50',
								  'size'        => '25',
								  //'style'       => 'width:50%',
								);
							...
							<?php
							$data8 = array(
								  'name'        => 'Movie_TrailerURL',
								  'id'          => 'Movie_TrailerURL',
								  'value'       => $data['Movie_TrailerURL'],
								  'maxlength'   => '50',
								  'size'        => '25',
								  //'style'       => 'width:50%',
								);
