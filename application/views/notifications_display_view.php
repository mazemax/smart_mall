...
?>
<title>Smart Mall - View Notifications</title>
...
function do_delete(id)
{
	...
	if (r==true)
	  window.location = url+"/notifications_delete/"+id;
	else
	  return false;
}
</script>
                ...
                <div>
					...
					<p class="blocktext">
						...
						if(!empty($notifications))
						{
							...
							{
								echo "<tr>";
								echo "<td>".$n['Notification_Name']."</td>";
								echo "<td>".$n['Notification_StartDate']."</td>";
								echo "<td>".$n['Notification_EndDate']."</td>";
								echo "<td><a href='".$controller_url."/notifications_update/".$n['Notification_ID']."'><img src='".$content_url."images/Edit.png'></a></td>";
								echo "<td><a href='javascript:void(0);' onClick='do_delete(".$n['Notification_ID'].");'><img src='".$content_url."images/Delete.png' /></a></td>";
								echo "</tr>";
							}
						}
						?>
