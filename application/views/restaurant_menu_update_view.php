...
?>
<title>Smart Mall - Update Restaurant Menu</title>
                ...
                <div>
					...
					<br/>-->
						...
						<?php echo validation_errors(); 
							  ...
							  echo form_open_multipart("$controller_url"."/restaurant_menu_update/".$data['Item_ID'], $attributes);
						?>
							<p class="blocktext">
							Item Name:
							<?php
