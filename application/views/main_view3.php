...
function do_delete(id)
{
	...
	if (r==true)
	  window.location = url+"/restaurant_menu_delete/"+id;
	else
	  return false;
}
</script>
            ...
            <div class="post-info">
                ...
                <div>
					...
					<p class="blocktext">
						...
						if(!empty($r_menus))
						{
							foreach($r_menus as $m)
							{
								echo "<tr>";
								echo "<td>".$m['Item_ID']."</td>";
								echo "<td>".$m['Item_Name']."</td>";
								echo "<td>".$m['Item_Price']."</td>";
								echo "<td><a href='".$controller_url."/restaurant_menu_update/".$m['Item_ID']."'><img src='".$content_url."images/Edit.png'></a></td>";
								echo "<td><a href='javascript:void(0);' onClick='do_delete(".$m['Item_ID'].")'><img src='".$content_url."images/Delete.png'/></a></td>";
								echo "</tr>";
							}
						}
						?>
